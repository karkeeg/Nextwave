  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${article.category}, AI, Technology, NextWave AI`}
        />
        <meta name="author" content={article.author} />
        <link
          rel="canonical"
          href={`https://nextwaveai-8.vercel.app/blog/${id}`}
        />
      </Helmet>

      <section
        ref={articleRef}
        className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-white relative overflow-hidden pt-8 md:pt-12"
      >
        ...
        <AnimatePresence>
          ...
          />
          <motion.div
            className="absolute top-40 left-40 w-80 h-80 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-20"
            style={{ y: y3 }}
            animate={{
              scale: [1, 1.15, 1],
            }}
